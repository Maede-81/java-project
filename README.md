...
### 📝 Overview  
A simple console-based calculator that performs the **four basic arithmetic operations** (addition, subtraction, multiplication, division).  
It takes user input from the terminal and displays the calculated result immediately.
